...
int main(int argc, char **argv) {
  ...
  // cout << "random agent: " << Evaluator::Evaluate(randomAgent.get(), false)
  //      << endl;
  //
  // uptr<learning::LearningAgent> learningAgent =
  //     make_unique<learning::LearningAgent>();
  // cout << "learning agent start: "
  //      << Evaluator::Evaluate(learningAgent.get(), false) << endl;
  //
  // learning::Trainer trainer;
  // trainer.TrainAgent(learningAgent.get(), 300000);
  //
  // cout << "learning agent end: "
  //      << Evaluator::Evaluate(learningAgent.get(), false) << endl;
